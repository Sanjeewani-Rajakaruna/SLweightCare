...
$snack3     = implode('<br>', $_POST['snack3']);
    ...
    $query1="INSERT INTO dietplans (username,category,breakfast,snack1,lunch,snack2,dinner,snack3) VALUES ('$username','vegetarian', '" . $breakfast . "', '" . $snack1 . "','" . $lunch . "','" . $snack2 . "','" . $dinner . "','" . $snack3 . "')   ";     

    mysqli_query($db,$query1);

    header('location: vegplanscuztomize.php');
 ...
 ?>
   ...
   <h1 class="text mt-5 text-center text-light" ><b>Start cuztomize your diet plan here!</b> </h1><br>
    <a href="vegplans.php" class="btn btn-warning btn-lg" ><b>BACK</b></a> 
   <hr>

   <div class="row">
    <form action="vegplanscuztomize.php" method="post" style="background-color: tomato">
...
$sql = "SELECT * FROM dietplans where username='$username'AND category='vegetarian'  ";
